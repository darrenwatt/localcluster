...
<head>
    ...
    <!--====== Title ======-->
    <title>Darren Watt - Test Kubenetes Landing Page</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="header-hero-content text-center">
                            <h3 class="header-sub-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">Darren's Kubernetes Test Page</h3>
                            <h2 class="header-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">This is running on multiple K8s pods</h2>
			    <p class="text wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">This server is <?php echo $_SERVER['SERVER_ADDR'] ?></p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-5 col-sm-5">
                        <div class="footer-contact mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                            ...
                            <ul class="contact">
                                <li>+44 number number</li>
                                <li>info@gmail.com</li>
                                <li>k8s.darrenwatt.com</li>
                                <li>Not New York City , United <br> States Of America.</li>
                            </ul>
                        </div> <!-- footer contact -->
                    </div>
                </div> <!-- row -->
